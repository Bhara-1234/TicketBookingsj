...
public class BookingServletFunction {
	...
	public Ticket tpassList(String from,String to,String train,String cls,String dt,String[] name,String[] age,String[] gender,double f){
		ArrayList<Passengers> app=new ArrayList<>();
		for(int i=0;i<name.length;i++) {
			app.add(new Passengers(name[i],age[i],gender[i]));
		}
		Ticket t = new Ticket(from,to,train,cls,dt,app,f);
		return t;
	}
}